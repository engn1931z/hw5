...
##################################################################
def yourSubmission():
	return {'email':email,'hw':5,'input':address,'state':stateAbbrev,'district':districtNumber,'senator':senatorFullName,'bill':sponsoredBillTitle}